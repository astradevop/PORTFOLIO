                        ...
                        <div className="flex flex-col justify-center space-y-10">
                            ...
                            <div className="pt-4">
                                ...
                                <div className="flex items-center gap-3">
                                    <a className="group flex items-center justify-center size-12 rounded-full bg-gray-200 dark:bg-[#2b2839] hover:bg-primary hover:text-white transition-all duration-300" href="https://github.com/astradevop" target="_blank" rel="noopener noreferrer">
                                    ...
                                    <a className="group flex items-center justify-center size-12 rounded-full bg-gray-200 dark:bg-[#2b2839] hover:bg-primary hover:text-white transition-all duration-300" href="https://www.linkedin.com/in/aakash-s-nair" target="_blank" rel="noopener noreferrer">

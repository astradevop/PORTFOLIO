...
export default function Tools() {
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark text-[#111418] dark:text-white overflow-x-hidden min-h-screen flex flex-col">
            {/* Top Navigation */}
            <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#2b2839] bg-background-dark/95 backdrop-blur-sm px-10 py-3">
            ...
            <main className="flex-grow flex flex-col pt-24 pb-12 px-4 md:px-10 lg:px-40 max-w-[1440px] mx-auto w-full">
                {/* Header Section */}
                <div className="flex flex-col gap-6 py-10 animate-fade-in-up">
                    <div className="flex flex-col gap-3">
                        ...
                        <p className="text-[#a19db9] text-lg font-normal leading-relaxed max-w-2xl font-display">
